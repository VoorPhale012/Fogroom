...
local assets = {
	Repentance = LoadCustomInstance("https://raw.githubusercontent.com/VoorPhale012/Crucifix/refs/heads/main/repee.rbxm?raw=true")
}
local moduleScripts = {
...
function CrucifixEntity(entityTable, tool)
	...
	sound:Play()
game.Workspace.RepentanceNEW.Crucifix.Color = Color3.fromRGB(255, 0, 0)
game.Workspace.RepentanceNEW.Crucifix.ExplodeParticle.Brightness = 0.1

local crucifixTool = character:WaitForChild("Crucifix",10000000000000000000000000000000)

if not crucifixTool then
    crucifixTool = player.Backpack:WaitForChild("Crucifix",1000000000000000000000000000)
end
